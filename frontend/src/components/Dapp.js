  ...
  render() {
    ...
    return (
      <div className="container p-4">
        ...
        {/* <h3>Multi-Sig Wallet USDT Balance </h3> */}
        <div className="row">
        ...
        />
        <TransactionDetails 
          txn={this.state.getTxn}
          confirmTxn={(index) =>
            this._confirmTxn(index)
          }
          revokeTxn={(index) =>
            this._revokeTxn(index)
          }
          executeTxn={(index) =>
            this._executeTxn(index)
          }
          />
        </div>      
      </div>     
